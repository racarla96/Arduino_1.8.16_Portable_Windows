...
PID::PID(double Kp, double Ki, double Kd, double upper_limit, double lower_limit, double sampleTime) {
    PID::setSampleTime(sampleTime);
    PID::setGains(Kp, Ki, Kd);
    PID::setOutputLimits(lower_limit, upper_limit);   // Default limits to generate a 8 bit resolution PWM control signal
