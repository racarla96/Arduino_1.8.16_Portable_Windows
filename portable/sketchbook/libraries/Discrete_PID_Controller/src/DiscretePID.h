...
class DiscretePID {
    public:
        ...
        * \param[in]    upper_limit The windup upper limit action control restriction.
        * \param[in]    lower_limit The windup upper limit action control restriction.
        * \param[in]    sampleTime  The execution period of the controller (in seconds).
        * \Details
        ...
        * output limits to a pair of values and sets the state variables to 
        * all zeros.
        */
        PID(double Kp, double Ki, double Kd, double upper_limit, double lower_limit, double sampleTime);
        /**
        ...
        * \param[in]    sampleTime  User-defined sample time (in seconds).
        * \return       None.
        */
